...
class AnalyzeLastVideoFrameStepMessageHandler extends AbstractAnalyzeFrameStepMessageHandler
{
    ...
    public function __invoke(AnalyzeLastVideoFrameStepMessage $message): void
    {

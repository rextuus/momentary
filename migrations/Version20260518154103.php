 ...
 */
final class Version20260518154103 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video ADD COLUMN delete_local_file_after_analysis BOOLEAN DEFAULT 1 NOT NULL');
    }
}
